        ...
        <div class="module_main">
          <a href=<?= get_permalink($tips[0]) ?> class="module_link">
            ...
            <div class="module_text_container">
              ...
              <time datetime="<?= $helper::getModifiedDate($tips[0], "Y-m-d\TH:i:sP"); ?>" class="module_text_time">
                <?= $helper::getModifiedDate($tips[0], "M d, Y h:i A"); ?>
              </time>
            </div>
          </a>
        </div>
      ...
      ?>
          <div class="top-tips-module">
            ...
            <div class="module_main">
              ...
              <time datetime="<?= $helper::getModifiedDate($value, "Y-m-d\TH:i:sP"); ?>" class="module_text_time">
