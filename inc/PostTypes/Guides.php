...
class Guides implements CustomPostType
{

    public static string $singularName = "How to Guide";
    public static string $pluralName = "How to Guides";
    ...
    public static function getPostTypeConfig(): array
    {
        ...
        return [
            ...
            "hierarchical" => true,
            "rewrite" => ["slug" => self::getPostType(), "with_front" => true],
            "query_var" => true,
