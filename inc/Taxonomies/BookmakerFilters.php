...
class BookmakerFilters implements Categories
{

    private string $category_singular_name = "Bookmaker-Filter";
    private string $category_plural_name = "Bookmaker-Filters";
    private string $category_slug = "bookmaker_filters";
    ...
    {
        $labels = [
            'name'                      => __( str_replace('-',' ', $this->category_plural_name ), 'Bookmaker Filters' ),
            'singular_name'             => __( str_replace('-',' ', $this->category_singular_name ), 'Bookmaker Filter' ),
