...
class BookmakerFeatures implements Categories
{

    private string $category_singular_name = "Bookmaker-Features";
    private string $category_plural_name = "Bookmaker-Features";
    private string $category_slug = "bookmaker_features";
    ...
    {
        $labels = [
            'name'                      => __( str_replace('-',' ', $this->category_plural_name ), 'Bookmaker Features' ),
            'singular_name'             => __( str_replace('-',' ', $this->category_singular_name ), 'Bookmaker Features' ),
