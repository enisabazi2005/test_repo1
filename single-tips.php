...
while (have_posts()) : the_post(); 
    ...
    if ( function_exists('yoast_breadcrumb') && !is_front_page() ) {
        $helper::displaySection('breadcrumbs-section');
    }
    ?>
    ...
    <section class="tips-wrapper container">
        <article class="content">
        <?php if($show_thumbnail): ?>
            <figure class="tips-featured-image">
        ...
        <aside class="sidebar">
        <?php
            $helper::displaySection('aside-template-tips');
